...
export default async function DashboardPage() {
  ...
  return <div className="mx-auto max-w-6xl p-5 py-8 sm:p-8 lg:p-12">
    ...
    <PowerUpsCard powerUps={data.powerUps} completedPowerUpIds={data.completedPowerUpIds} />
